...
const EditPatient = ({ isOpen = false, onClose = () => {}, onSave = () => {}, patient }) => {
  ...
  useEffect(() => {
    if (patient) {
      ...
      setPhotoPreview(patient.photo ? `data:image/jpeg;base64,${patient.photo}` : null);
    }
  }, [patient]);
  ...
  const validateForm = () => {
    ...
    if (!formData.petIdentification.trim()) {
      newErrors.petIdentification = 'La identificación de la mascota es obligatoria';
    }
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      console.log("Datos enviados a updatePatient:", { patientData, photo: formData.photo });

      const updatedPatient = await updatePatient(patient.id, patientData, formData.photo);
    ...
    <div className="modal-overlay">
      <div className="edit-patient-container">
        <div className="edit-patient-header">
          <h2 className="edit-patient-title">Editar mascota</h2>
        </div>
        ...
        <div className="edit-patient-content">
          ...
          <div className="pet-info-section">
            ...
            <div className="pet-basic-info">
              ...
              <div className="form-row">
                <div className="form-field">
                  <label className="form-label">Identificación de la mascota</label>
                  <input
                    type="text"
